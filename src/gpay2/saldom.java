 ...
 * @author USER
 */
public class saldom extends javax.swing.JFrame {
    ...
    private void tabel() {
        ...
        try {
            ...
            res = stat.executeQuery("select a.nama, b.username, b.saldo from account a, saldo b where a.username = '" + user + "' and a.username = b.username");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(saldom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
